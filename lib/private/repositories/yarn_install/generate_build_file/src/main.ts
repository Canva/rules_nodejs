...
export function main() {
  ...
  // TODO Limit to top level packages, we only need the files of nested packages
...
function generateMacro(pkgs: Dep[]) {
  `
# This file is automatically generated
load("build_bazel_rules_nodejs//lib:rules.bzl", "nm_package")

# visibility arg only applies to direct deps
def node_modules(visibility = ["//visibility:public"]):
    nm_package(
        name = "node_modules/typescript",
        visibility = visibility,
        srcs = [
            # NOTE Using "Label" to refer to repo housing macro
            Label("//node_modules/typescript:files"),
        ],
        deps = [
            ":node_modules/foo",
        ],
