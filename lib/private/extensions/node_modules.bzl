    ...
    for mod in mctx.modules:
        ...
        for attrs in mod.tags.yarn:
            ...
            yarn_install(
                ...
                post_install_patches = attrs.post_install_patches,
                pre_install_patches = attrs.pre_install_patches,
                strict_visibility = attrs.strict_visibility,
                symlink_node_modules = attrs.symlink_node_modules,
