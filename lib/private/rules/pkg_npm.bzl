...
load("//lib/private:providers.bzl", "DeclarationInfo", "JSEcmaScriptModuleInfo", "JSModuleInfo", "JSNamedModuleInfo", "LinkablePackageInfo", "NODE_CONTEXT_ATTRS", "NodeContextInfo")
...
PKG_NPM_ATTRS = dict(NODE_CONTEXT_ATTRS, **{
    ...
    "_npm_script_generator": attr.label(
        default = Label("//lib/internal/rules/pkg_npm:npm_script_generator"),
        cfg = "exec",
        executable = True,
    ),
    "_packager": attr.label(
        default = Label("//lib/internal/rules/pkg_npm:packager"),
        cfg = "exec",
        executable = True,
    ),
    # TODO Use toolchains or remove
