...
_ATTRS = {
    "amd_names": attr.string_dict(
        doc = """
            Non-public legacy API, not recommended to make new usages.
...
AmdNamesInfo = provider(
    ...
    fields = {
        "names": """
            Mapping from require module names to global variables.
...
def write_amd_names_shim(actions, amd_names_shim, targets):
    ...
    amd_names_shim_content = dedent("""
        // GENERATED by js_library.bzl
